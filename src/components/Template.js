...
export default function Template({ template, sendMessages }) {
    ...
    <div className="mx-auto my-4 w-full max-w-4xl px-2">
      ...
      <div>
        <button
          ...
          className="rounded-md bg-blue-500 py-2 px-3 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-blue-600 active:bg-blue-700 dak:ring-0"
        >
          Start Conversation
        </button>
      </div>
