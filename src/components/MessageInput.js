  ...
  return (
    <div className="px-2 pb-2">
      <div className="mx-auto w-full max-w-4xl">
        <div className="flex items-end rounded-md border p-4 pr-2 dak:border-gray-400">
          <TextArea
            ref={inputRef}
            minRows={1}
            maxRows={10}
            ...
            className={cn(
              ...
              "w-full flex-1 resize-none self-center bg-transparent leading-tight focus:outline-none dak:border-gray-500"
            )}
            value={prompt}
